...
struct KPrefSchema {
    ...
    static let table: [String : KPrefSchema] = [
        ...
        "parser.base.show.invisibles.fullwidth_space" : .init(type: .bool),
        ...
        "parser.base.invisibles.glyph.fullwidth_space" : .init(type: .string),
        ...
        // ---- parser.base color.dark ----
        "parser.base.color.text.dark"                : .init(type: .color),
        "parser.base.color.background.dark"          : .init(type: .color),
        "parser.base.color.literal.dark"             : .init(type: .color),
        "parser.base.color.comment.dark"             : .init(type: .color),
        "parser.base.color.variable.dark"            : .init(type: .color),
        "parser.base.color.keyword.dark"             : .init(type: .color),
        "parser.base.color.numeric.dark"             : .init(type: .color),
        "parser.base.color.invisibles.dark"          : .init(type: .color),
        "parser.base.color.completion.dark"          : .init(type: .color),
        "parser.base.color.selection_highlight.dark" : .init(type: .color),
